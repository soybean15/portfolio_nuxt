        ...
        <ul class="menu menu-lg menu-vertical md:menu-horizontal w-full text-base-content  md:px-10 ">
            ...
            <li class="order-3  md:flex hidden ">
                <details class="dropdown  ">
                    ...
                    <ul class="p-2 shadow menu dropdown-content   z-[1] bg-base-200  rounded-box bg-transparent   ">
                        <li class=" flex  ">
                         
                            <label  class="swap swap-rotate ">

                                <!-- this hidden checkbox controls the state -->
                                <input @click="nav.toggleDarkMode()"  type="checkbox" class="theme-controller" value="synthwave" />
            ...
            <li class="order-3  flex md:hidden ">
                <details class="dropdown ">
                    <summary class="mx-1 w-full  btn btn-ghost"></summary>
                    <ul class="p-2 shadow menu dropdown-content   z-[1]  bg-neutral rounded-box ">
                        <li class=" w-full md:w-fit order-2"><a class="flex justify-center ">Dark</a></li>
